driver:
	@g++ -Wall -std=c++11 include/piece.cpp include/gameboard.cpp include/rook.cpp include/bishop.cpp include/knight.cpp include/pawn.cpp include/queen.cpp include/king.cpp drivers/testcase.cpp drivers/driver.cpp drivers/bishoptest.cpp drivers/driver-test.cpp -o drivers/test.out
